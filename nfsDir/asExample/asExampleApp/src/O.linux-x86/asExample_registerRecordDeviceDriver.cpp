...
/* Generated from ../O.Common/asExample.dbd */
...
epicsShareExtern reg_func pvar_func_arrInitialize,
    ...
    pvar_func_dbrestoreRegister, pvar_func_helloRegister,
    pvar_func_initTraceRegister, pvar_func_save_restoreRegister,
...
int asExample_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/long/nfsDir/asExample";
...
/* asExample_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"asExample_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    asExample_registerRecordDeviceDriver(*iocshPpdbbase);
}
