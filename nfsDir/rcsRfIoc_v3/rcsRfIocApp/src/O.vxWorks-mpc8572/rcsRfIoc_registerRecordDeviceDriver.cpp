...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devAiGeneralTime, *pvar_dset_devVXStatsSIM,
...
static const char * const deviceSupportNames[] = {
    ...
    "devVXStatsSIM", "devAiD212", "devAoSoft", "devAoSoftRaw",
    "devAoSoftCallback", "devAoD212", "devBiSoft", "devBiSoftRaw",
    "devBiSoftCallback", "devBiDbState", "devBiD212", "devBoSoft",
    "devBoSoftRaw", "devBoSoftCallback", "devBoGeneralTime",
    "devBoDbState", "devBoD212", "devAutoOn", "devAutoOff", "devAllOn",
    "devAllOff", "devCalcoutSoft", "devCalcoutSoftCallback",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devVXStatsSIM, pvar_dset_devAiD212, pvar_dset_devAoSoft,
    pvar_dset_devAoSoftRaw, pvar_dset_devAoSoftCallback,
    pvar_dset_devAoD212, pvar_dset_devBiSoft, pvar_dset_devBiSoftRaw,
    pvar_dset_devBiSoftCallback, pvar_dset_devBiDbState,
    pvar_dset_devBiD212, pvar_dset_devBoSoft, pvar_dset_devBoSoftRaw,
    pvar_dset_devBoSoftCallback, pvar_dset_devBoGeneralTime,
    pvar_dset_devBoDbState, pvar_dset_devBoD212, pvar_dset_devAutoOn,
