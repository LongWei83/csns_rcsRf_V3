...
/* Generated from ../O.Common/rcsRfIoc.dbd */
...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devAiGeneralTime, *pvar_dset_devAiD212,
    *pvar_dset_devAoSoft, *pvar_dset_devAoSoftRaw,
    *pvar_dset_devAoSoftCallback, *pvar_dset_devAoD212,
    *pvar_dset_devBiSoft, *pvar_dset_devBiSoftRaw,
    *pvar_dset_devBiSoftCallback, *pvar_dset_devBiDbState,
    *pvar_dset_devBiD212, *pvar_dset_devBoSoft, *pvar_dset_devBoSoftRaw,
    *pvar_dset_devBoSoftCallback, *pvar_dset_devBoGeneralTime,
    *pvar_dset_devBoDbState, *pvar_dset_devBoD212, *pvar_dset_devAutoOn,
    *pvar_dset_devAutoOff, *pvar_dset_devCalcoutSoft,
    ...
    *pvar_dset_devSASoft, *pvar_dset_devWfSoft, *pvar_dset_devWrRd,
    *pvar_dset_devWfD212, *pvar_dset_devWfWr1, *pvar_dset_devWfWr2,
    *pvar_dset_devXWf;
...
static const char * const deviceSupportNames[] = {
    ...
    "devAiD212", "devAoSoft", "devAoSoftRaw", "devAoSoftCallback",
    "devAoD212", "devBiSoft", "devBiSoftRaw", "devBiSoftCallback",
    "devBiDbState", "devBiD212", "devBoSoft", "devBoSoftRaw",
    "devBoSoftCallback", "devBoGeneralTime", "devBoDbState", "devBoD212",
    "devAutoOn", "devAutoOff", "devCalcoutSoft", "devCalcoutSoftCallback",
    ...
    "devSoStdio", "devSASoft", "devWfSoft", "devWrRd", "devWfD212",
    "devWfWr1", "devWfWr2", "devXWf"
};
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devAiD212, pvar_dset_devAoSoft, pvar_dset_devAoSoftRaw,
    pvar_dset_devAoSoftCallback, pvar_dset_devAoD212, pvar_dset_devBiSoft,
    pvar_dset_devBiSoftRaw, pvar_dset_devBiSoftCallback,
    pvar_dset_devBiDbState, pvar_dset_devBiD212, pvar_dset_devBoSoft,
    pvar_dset_devBoSoftRaw, pvar_dset_devBoSoftCallback,
    pvar_dset_devBoGeneralTime, pvar_dset_devBoDbState,
    pvar_dset_devBoD212, pvar_dset_devAutoOn, pvar_dset_devAutoOff,
    ...
    pvar_dset_devWrRd, pvar_dset_devWfD212, pvar_dset_devWfWr1,
    pvar_dset_devWfWr2, pvar_dset_devXWf
};
...
epicsShareExtern reg_func pvar_func_arrInitialize,
    ...
    pvar_func_register_func_maxHold, pvar_func_register_func_myAsubInit,
...
int rcsRfIoc_registerRecordDeviceDriver(DBBASE *pbase)
{
    static int executed = 0;
    const char *bldTop = "/home/long/nfsDir/rcsRfIoc_v3";
...
/* rcsRfIoc_registerRecordDeviceDriver */
static const iocshArg rrddArg0 = {"pdbbase", iocshArgPdbbase};
static const iocshArg *rrddArgs[] = {&rrddArg0};
static const iocshFuncDef rrddFuncDef =
    {"rcsRfIoc_registerRecordDeviceDriver", 1, rrddArgs};
static void rrddCallFunc(const iocshArgBuf *)
{
    rcsRfIoc_registerRecordDeviceDriver(*iocshPpdbbase);
}
