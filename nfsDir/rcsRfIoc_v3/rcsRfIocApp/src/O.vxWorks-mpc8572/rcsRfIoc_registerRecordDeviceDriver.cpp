...
epicsShareExtern dset *pvar_dset_devAaiSoft, *pvar_dset_devAaoSoft,
    ...
    *pvar_dset_devAutoOff, *pvar_dset_devAllOn, *pvar_dset_devAllOff,
...
static const char * const deviceSupportNames[] = {
    ...
    "devAutoOn", "devAutoOff", "devAllOn", "devAllOff", "devCalcoutSoft",
...
static const dset * const devsl[] = {
    ...
    pvar_dset_devAllOn, pvar_dset_devAllOff, pvar_dset_devCalcoutSoft,
